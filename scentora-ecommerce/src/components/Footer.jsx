            ...
            <div className="footer-container">
                ...
                <div className="footer-contact">
                    ...
                    <div className="contact-item">
                        <span><i class="fa fa-envelope footer-icon"></i><a href="mailto:johnson11ameyaw@gmail.com" rel='noopener noreferrer'>scentorafragrance@gmail.com</a></span>
                        <span><i class="fa fa-phone footer-icon"></i><a href="tel:+233242142297" rel='noopener noreferrer'>0242142297</a></span>
                        <span><i class="fa fa-map-marker-alt footer-icon"></i>KNUST, Kumasi, Ghana</span>
                    </div>
                </div>
            </div>
